...
class TimeSelecaoParcial {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TimeSelecaoParcial[] conjuntoTimes = new TimeSelecaoParcial[quantidadeDeFrases];
        
        //criar os objetos de acordo.
        for (int i = 0; i < quantidadeDeFrases; i++) {
            //criar o objeto e chamar o construtor
            conjuntoTimes[i] = new TimeSelecaoParcial(entradas[i]);
        }
        
        int totalComparacoes = ordenarSelecao(conjuntoTimes, 10);
        ...
        Arq.openWrite("649651_selecaoParcial.txt");
    ...
    public static void swap(TimeSelecaoParcial array[], int menor, int i){
        TimeSelecaoParcial aux = array[i];
        array[i] = array[menor];
        array[menor] = aux;
    ...
    public static int ordenarSelecao(TimeSelecaoParcial array[], int k){
        int comparacoes = 0;
