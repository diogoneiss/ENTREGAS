    ...
    //tamanho max da entrada
        ...
        */
        public static String simplificarOperacao(String fraseOriginal){
            ...
            fraseOriginal = simplificarNots(fraseOriginal);
		...
		*/
        ...
        public static String simplificarNots(String fraseOriginal){

            char bitDaOperacao;

            for(int x = fraseOriginal.length()-1; x >= 5; x--){
            // operacao simples é tipo and( A , B)
            boolean ehOperacaoUnitaria = fraseOriginal.charAt(x-2) == '(' && fraseOriginal.charAt(x) == ')';

            if(ehOperacaoUnitaria && fraseOriginal.charAt(x-3) == 't' && fraseOriginal.charAt(x-4) == 'o' && fraseOriginal.charAt(x-5) == 'n'){
                bitDaOperacao = operacaoNOT(fraseOriginal);
                fraseOriginal = substituirNaString(fraseOriginal, x-5, x, bitDaOperacao);
            }
